...
export type DraggableEventHandler = (e: MouseEvent, data: DraggableData) => false|void;
...
export default class DraggableCore extends React.Component<DraggableCoreProps, DraggableCoreState> {
  ...
  handleDragStart: EventHandler<MouseTouchEvent> = (e): false | void => {
  ...
  handleDragStop: EventHandler<MouseTouchEvent> = (e) => {
    ...
    // Call event handler
    this.props.onStop(e as MouseTouchEvent, coreEvent)
