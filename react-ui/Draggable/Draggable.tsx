...
import DraggableCore, { ControlPosition, PositionOffsetControlPosition, DraggableBounds, DraggableCoreProps } from './DraggableCore'
...
export default class Draggable extends React.Component<DraggableProps, DraggableState> {
  ...
  onDragStart: DraggableEventHandler = (e, coreData): false | void => {
  ...
  onDrag: DraggableEventHandler = (e, coreData): false|void => {
  ...
  onDragStop: DraggableEventHandler = (e, coreData): false | void => {
    if (!this.state.dragging) return false
