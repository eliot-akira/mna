...
// _.has, isFunction, isBoolean, map, filter..
...
function modify (obj, updateQuery) {
  ...
  if (keys.indexOf('id') !== -1 && updateQuery.id !== obj.id) { throw new Error("You cannot change a document's id") }
  ...
  if (obj.id !== newDoc.id) { throw new Error("You can't change a document's id") }
  return newDoc
}
