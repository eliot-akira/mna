...
class FriendlyErrorsWebpackPlugin {
  ...
  apply(compiler) {
    ...
    const invalidFn = () => {
      this.clearConsole()
      output.title('info', this.title || 'WAIT', 'Compiling..')
    }
  ...
  displaySuccess(stats) {
    ...
    output.title('success', this.title || 'DONE', 'Compiled in ' + time + 'ms')
  ...
  displayErrors(errors, severity) {
    ...
    output.title(severity, this.title || severity.toUpperCase(), subtitle)
